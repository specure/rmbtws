...
Object.defineProperty(exports,"__esModule",{value:!0}),exports.RMBTControlServerCommunication=void 0;var RMBTControlServerCommunication=exports.RMBTControlServerCommunication=function(e,r,i){var s=e,u=log&&log.getLogger?log.getLogger("rmbtws"):new MockLogger,a=(r=r||{}).register||null,c=r.submit||null,l=r.headers||{"Content-Type":"application/json"},d=s.additionalRegistrationParameters&&s.additionalRegistrationParameters.local_server_settings;return{obtainControlServerRegistration:function(r,t){var e,n,o;d?(e=new RMBTControlServerRegistrationResponse(d),r(e)):(n={version:s.version,language:s.language,uuid:s.uuid,type:s.type,version_code:s.version_code,client:s.client,timezone:s.timezone,time:(new Date).getTime(),measurement_server_id:i?i.id:void 0},Object.assign(n,s.additionalRegistrationParameters),"undefined"!=typeof userServerSelection&&0<userServerSelection&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(n.prefer_server=UserConf.preferredServer,n.user_server_selection=userServerSelection),fetch(s.controlServerURL+s.controlServerRegistrationResource,{method:"POST",headers:l,body:JSON.stringify(n)}).then(function(e){return e.json()}).then(function(e){o=e;e=new RMBTControlServerRegistrationResponse(e);r(e)}).catch(function(e){o=e,u.error("error getting testID"),u.debug("local_server_settings: ".concat(d)),t()}).finally(function(){null!=a&&"function"==typeof a&&a({response:o,request:n})}))},getDataCollectorInfo:function(){d||fetch(s.controlServerURL+s.controlServerDataCollectorResource,{method:"GET",headers:l}).then(function(e){return e.json()}).then(function(e){s.product=e.agent.substring(0,Math.min(150,e.agent.length)),s.model=e.product,s.os_version=e.version}).catch(function(){u.error("error getting data collection response")})},submitResults:function(r,t,n){Object.assign(r,s.additionalSubmissionParameters);var o,e=JSON.stringify(r);u.debug("Submit size: "+e.length),fetch(s.controlServerURL+s.controlServerResultResource,{method:"POST",headers:l,body:e}).then(function(e){return e.json()}).then(function(e){o=e,u.debug(r.test_uuid),t(!0)}).catch(function(e){o=e,u.error("error submitting results"),n(!1)}).finally(function(){null!==c&&"function"==typeof c&&c({response:o,request:r})})}}};
